    ...
    >
      <nav className="header__nav  container relative mx-auto flex xl:flex-row flex-col items-start px-10">
        <div className="header__logo-wrap flex justify-between">
          <a href="/">
            <img
              className={isMobile ? "w-20 py-4 header-logo" : "w-52 header-logo"}
        ...
        <ul className={menuOpen ? "open nav__wrapper" : "nav__wrapper"}>
          <div className="flex xl:flex-row flex-col items-center w-full justify-center">
            <li
                className={
                  scroll < 200 ? "drop-shadow-5xl xl:mb-0 mb-3 nav__popup-wrap" : "xl:mb-0 mb-3 nav__popup-wrap"
                }
              >
                <Popup
                  ...
                  trigger={
                    <h1
                      className={
                        scroll < 200
                          ? "nav__link mx-3.5 font-bold px-2.5 py-1 2xl:text-xl text-lg rounded-none uppercase cursor-pointer drop-shadow-5xl text-white"
                          : "nav__link mx-3.5 font-bold px-2.5 2xl:text-xl text-lg py-1 rounded-none uppercase cursor-pointer text-regal-red"
                      }
                    >
                      בחר מדינה
                    </h1>
              ...
              navsMain.map((nav) => (
                ...
                >
                  <a
                    ...
                    className={
                      scroll < 200
                        ? "nav__link mx-3.5 font-bold px-2.5 py-1 2xl:text-xl text-lg rounded-none uppercase cursor-pointer drop-shadow-5xl text-white hover:border-regal-red hover:border-b-2"
                        : "nav__link mx-3.5 font-bold px-2.5 2xl:text-xl text-lg py-1 rounded-none uppercase cursor-pointer text-regal-red hover:border-regal-red hover:border-b-2"
                    }
                  >
                    {nav.title}
                  </a>
